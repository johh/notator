...
export { default as Sound } from './lib/Sound';

export { default as BiquadFilter } from './lib/effects/BiquadFilter';
export { default as Convolver } from './lib/effects/Convolver';
export { default as Delay } from './lib/effects/Delay';
export { default as DynamicsCompressor } from './lib/effects/DynamicsCompressor';
export { default as Gain } from './lib/effects/Gain';
export { default as EffectController } from './lib/effects/EffectController';
